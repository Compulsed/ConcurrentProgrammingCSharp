...
namespace DSalter.Submissions
{
	...
	public class __SemaphoreTest
	{
		...
		static Semaphore writePermission = new Semaphore(1);
		...
		static Semaphore barrierPermission = new Semaphore(0);
		static int count = 0;
		 ...
		 * ----------------------------
		 */
		static Semaphore testPermission = new Semaphore(1);
		...
		static Semaphore howMuchToWriteSema = new Semaphore(0);
